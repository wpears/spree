(function(W,D){
  ...
  toggleControls=function(){
    ...
    (function() {
      ...
      sheet.addRule("#spreeCon","color:#444;width:600px;height:100px;top:50%;left:50%;margin:-50px 0 0 -300px;box-shadow:0 4px 6px -4px #666, 0 1px 2px 0 #666;text-align:left;font-size:36px!important;line-height:100px;font-weight:300;padding:0;",0);
      sheet.addRule(".spreeaftwrap","float:right;border:0;width:350px;line-height:100px;display:inline-block;background:#fffefc;font-size:36px",1);
